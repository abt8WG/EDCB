...
#define CMD2_EPG_SRV_ISREGIST_GUI_TCP		9 //TCP接続のGUIアプリケーションのIPとポートの登録状況確認 (tkntrec氏版)

#define CMD2_EPG_SRV_AUTH_REQUEST           49 // 接続認証要求 (abt8WG氏版)
#define CMD2_EPG_SRV_AUTH_REPLY             50 // 接続認証応答 (abt8WG氏版)
...
#define CMD2_EPG_SRV_ENUM_REC_FOLDER        1027 //録画保存場所一覧取得 (abt8WG氏版)
...
//#define CMD2_EPG_SRV_FILE_COPY2			2060 //指定ファイルをまとめて転送する (tkntrec氏 バージョン情報追加対応版)
...
#define CMD2_EPG_SRV_UPDATE_SETTING			1064 //INIファイルを更新する (abt8WG氏版)
...
//外部アプリ再生用
#define CMD2_EPG_SRV_GET_NETWORK_PATH		1299 //録画ファイルのネットワークパスを取得 (niisaka氏版)
...
#define CMD2_EPG_SRV_GET_RECINFO_LIST2		2022 //録画済み情報一覧取得（指定IDリスト） (tkntrec氏版)
...
#define CMD2_EPG_SRV_FILE_COPY2				2060 //指定ファイルをまとめて転送する (tkntrec氏版)
#define CMD2_EPG_SRV_SEARCH_PG2				2125 //番組検索 (tkntrec氏版)
#define CMD2_EPG_SRV_SEARCH_PG_BYKEY2		2127 //番組検索、キーごとのイベントを全て返す (tkntrec氏版)
...
#define CMD2_EPG_SRV_GET_STATUS_NOTIFY2		2200 //サーバーの情報変更通知を取得（ロングポーリング） (xtne6f氏版)
